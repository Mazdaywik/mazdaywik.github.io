...
![pics/2070-fab2.dot](pics/2070-fab2.png)
...
Сложность этой функции — экспоненциальная, причём показателем экспоненты
...
![pics/5000-fib.dot](pics/5000-fib.png)

Просуперкомпилируем метаконфигурацию `M0` (входная точка `<Fib #e.0#>`)

![pics/5010-fib.dot](pics/5010-fib.png)
...
![pics/5020-fib.dot](pics/5020-fib.png)
...
![pics/5030-fib.dot](pics/5030-fib.png)

Строим `M2`. Граф можно посмотреть [по ссылке](pics/5040-fib.png), остаточная
программа
...
![pics/5050-fib.dot](pics/5050-fib.png)
...
![pics/5060-fib.dot](pics/5060-fib.png)

Строим `M4`. Граф можно увидеть [по ссылке](pics/5070-fib.png), остаточная
программа:
...
![pics/5080-fib.dot](pics/5080-fib.png)
...
![pics/5090-fib.dot](pics/5090-fib.png)
...
![pics/5100-fib.dot](pics/5100-fib.png)
...
![pics/5110-fib.dot](pics/5110-fib.png)
...
![pics/5120-fib.dot](pics/5120-fib.png)
...
![pics/5130-fib.dot](pics/5130-fib.png)
...
![pics/5140-fib.dot](pics/5140-fib.png)

`M11` строится тривиально,

![pics/5150-fib.dot](pics/5150-fib.png)

Строим метаконфигурацию `M12`. Её граф [по ссылке](pics/5160-fib.png),
остаточная программа
...
![pics/5170-fib.dot](pics/5170-fib.png)

Метаконфигурация `M13` строится просто.

![pics/5180-fib.dot](pics/5180-fib.png)
...
![pics/5190-fib.dot](pics/5190-fib.png)
...
![pics/5200-fib.dot](pics/5200-fib.png)
...
![pics/5210-fib.dot](pics/5210-fib.png)

Граф построен полностью. Сократим транзитные вершины для наглядности:

![pics/5220-fib.dot](pics/5220-fib.png)
...
![pics/6000-fib2.dot](pics/6000-fib2.png)
...
![pics/6010-fib2.dot](pics/6010-fib2.png)

Метаконфигурация `M1` строится тривиально.

![pics/6020-fib2.dot](pics/6020-fib2.png)

Строим граф для `M2`. [Граф построили](pics/6030-fib2.png). Остаточная
программа:
...
![pics/6040-fib2.dot](pics/6040-fib2.png)

С `M3` всё просто:

![pics/6050-fib2.dot](pics/6050-fib2.png)

`M4` придётся суперкомпилировать. Граф [доступен по ссылке](pics/6060-fib2.png),
остаточная программа
...
![pics/6070-fib2.dot](pics/6070-fib2.png)
...
![pics/6080-fib2.dot](pics/6080-fib2.png)
...
![pics/6090-fib2.dot](pics/6090-fib2.png)

Метаконфигурация `M7` будет иметь [такой граф](pics/6100-fib2.png) и такую
...
![pics/6110-fib2.dot](pics/6110-fib2.png)
...
![pics/6120-fib2.dot](pics/6120-fib2.png)

Метаконфигурация `M10` имеет [граф](pics/6130-fib2.png) и остаточную программу
...
![pics/6140-fib2.dot](pics/6140-fib2.png)

Граф построен полностью. Немного подсократим его, убрав транзитные переходы:

![pics/6150-fib2.dot](pics/6150-fib2.png)
...
Продукты дистилляции: самогон, виски, ром.
